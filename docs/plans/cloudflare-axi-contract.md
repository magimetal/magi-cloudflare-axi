...
Capability contract: catalog proves 172 registered source names at commit `70ff690553722f731849ede6ba9ce98958395a23`. It does not prove complete Zod schemas, SDK methods, or direct REST templates. Compact list output carries only name, family, operation, and catalog access classification. Live `tool list/schema` is authoritative for hosted invocation.
